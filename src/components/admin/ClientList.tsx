...
import { Plus, Edit, Trash2, Loader2, User, Calendar, CheckCircle, XCircle } from 'lucide-react';
    ...
    <div>
      ...
      {clients.length === 0 ? (
        <div className="bg-white shadow rounded-lg p-6 text-center">
          <p className="text-gray-600 mb-4">No clients found. Add your first client to get started.</p>
          <Button 
            variant="primary" 
            onClick={() => setIsAddModalOpen(true)}
            icon={<Plus className="h-4 w-4" />}
